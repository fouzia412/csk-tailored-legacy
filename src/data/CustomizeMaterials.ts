import { useCustomizeShirtMaterials } from "./customizeShirtMaterials";
import { customizeSuitMaterials } from "./customizeSuitMaterials";
import { customizeWeddingMaterials } from "./customizeWeddingMaterials";

export type OutfitType = "Suit" | "Shirt" | "Wedding_outfit";
export type ShirtVariation =
  | "Shirt (Full Hands)"
  | "Shirt (Half Hands)"
  | "Mandarin Full Hands"
  | "Mandarin Half Hands";
...
export const outfitOptions: OutfitType[] = ["Suit", "Shirt", "Wedding_outfit"];
export const shirtVariations: ShirtVariation[] = [
  "Shirt (Full Hands)",
  "Shirt (Half Hands)",
  "Mandarin Full Hands",
  "Mandarin Half Hands",
